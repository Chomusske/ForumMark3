            ...
            <table class="min-w-full">
                ...
                <thead style="border-radius:6px;">
                    <tr class=" text-sm font-medium bg-gray-300 text-left" style="background-color:#FC9B5C; ">
                        ...
                        <x-table.head>Имя</x-table.head>
                        <x-table.head>отображаемое</x-table.head>
                        <x-table.head class="text-center">Дата создаия</x-table.head>
                        <x-table.head class="text-center">действия</x-table.head>
                    </tr>
                </thead>
