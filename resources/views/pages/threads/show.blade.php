    ...
    <main class="grid grid-cols-4 gap-8 mt-8 wrapper">
        ...
        <section class="flex flex-col col-span-3 gap-y-4">
            ...
            <div class="mt-6 space-y-5">
                <h2 class="mb-0 text-sm font-bold uppercase">Комментарии</h2>
                <hr>
            ...
            <div class="p-5 space-y-4 bg-white shadow rounded-lg">
                <h2 class="text-gray-500">Оставить комментарий</h2>
            ...
            <div class="flex justify-between p-4 text-gray-700 bg-blue-200 rounded">
                <h2>Вы должны войти в систему, прежде чем оставлять комментарий</h2>
